...
* install node.js and run `scripts/QuizTreamServer.js`
...
Requires a webserver, node.js + `./scripts/QuizTreamServer.js` or your backend server that hosts the angular static files.
...
* serve your project directory with your http/backend server or node.js + `scripts/QuizTreamServer.js`
* to run do one of:
...
## Directory Layout
    ...
    scripts/            --> handy shell/js/ruby scripts
      ...
      QuizTreamServer.js     --> simple development webserver based on node.js
